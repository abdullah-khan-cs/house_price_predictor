...
- Current mapping priority for Lahore per-marla behavior:
	- Zameen residential plot indices (type_id=12) (primary)
	- Zameen house indices (type_id=9) (fallback when needed)
...
<div align="center">
	<img src="images/1.PNG" alt="App screenshot 1" width="1100" />
	<br/><br/>
	<img src="images/2.PNG" alt="App screenshot 2" width="1100" />
	<br/><br/>
	<img src="images/3.PNG" alt="App screenshot 3" width="1100" />
	<br/><br/>
	<img src="images/4.PNG" alt="App screenshot 4" width="1100" />
</div>